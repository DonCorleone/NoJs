...
| text-wrap | `text-wrap-balance-pretty.html` | text-wrap: balance evens out heading line lengths; text-wrap: pretty removes orphaned words from paragraphs — progressive enhancement, unsupported browsers ignore it gracefully. | text-wrap: balance, text-wrap: pretty, progressive enhancement |
